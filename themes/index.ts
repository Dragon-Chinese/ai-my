export const lightTheme = {
  ...
  // '--g-sub-sidebar-menu-color': 'rgba(255,255,255,0.8);',
  '--g-sub-sidebar-menu-hover-bg': 'hsl(var(--accent))',
  // '--g-sub-sidebar-menu-hover-bg': 'linear-gradient( 90deg, rgba(62,97,255,0.69) 0%, rgba(62,97,255,0.12) 100%);',
  '--g-sub-sidebar-menu-hover-color': 'hsl(var(--accent-foreground))',
  '--g-sub-sidebar-menu-active-bg': 'hsl(var(--primary))',
  // '--g-sub-sidebar-menu-active-bg': 'linear-gradient( 90deg, rgba(62,97,255,0.69) 0%, rgba(62,97,255,0.12) 100%);',
